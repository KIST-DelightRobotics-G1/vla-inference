...
from thirdparty.gr00t.configs.model.gr00t_n1d7 import Gr00tN1d7Config
from thirdparty.gr00t.model.modules.dit import AlternateVLDiT, DiT, SelfAttentionTransformer
from thirdparty.gr00t.model.modules.embodiment_conditioned_mlp import (
    CategorySpecificMLP,
...
def get_backbone_cls(config: Gr00tN1d7Config):
    if "nvidia/Cosmos-Reason2" in config.model_name or "Qwen/Qwen3-VL" in config.model_name:
        ...
        from thirdparty.gr00t.model.modules.qwen3_backbone import Qwen3Backbone

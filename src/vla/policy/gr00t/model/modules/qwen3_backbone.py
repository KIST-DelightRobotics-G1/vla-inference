...
class Qwen3Backbone(torch.nn.Module):
    def __init__(
        ...
        (Upstream also takes tune_llm/tune_visual/tune_top_llm_layers/
        trainable_params_fp32 — requires_grad plumbing for finetuning — plus
        the never-read reproject_vision/projector_dim; trimmed with the
        training path.)

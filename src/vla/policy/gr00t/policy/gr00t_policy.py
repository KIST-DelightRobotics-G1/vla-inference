...
This module provides the core policy class for running Gr00t models:
- Gr00tPolicy: Base policy class for model inference

(Upstream also ships Gr00tSimPolicyWrapper for the Gr00t sim environments;
that was trimmed from this extraction — real-robot deployment feeds
Gr00tPolicy directly.)
"""
...
from vla.policy.gr00t.data.embodiment_tags import FINETUNE_ONLY_TAGS, POSTTRAIN_TAGS, EmbodimentTag
from vla.policy.gr00t.data.interfaces import BaseProcessor
from vla.policy.gr00t.data.types import MessageType, ModalityConfig, VLAStepData
...
class Gr00tPolicy(BasePolicy):
    ...
    def __init__(
        ...
        *,
        ...
        """
        # Register Gr00tN1d7 with AutoModel/AutoProcessor. Upstream imports
        # gr00t.model, whose __init__ drags in the whole training pipeline
        # (DatasetFactory, dist utils); the registrations actually live at the
        # bottom of these two modules, so import them directly.
        import vla.policy.gr00t.model.gr00t_n1d7.gr00t_n1d7  # noqa: F401
        import vla.policy.gr00t.model.gr00t_n1d7.processing_gr00t_n1d7  # noqa: F401

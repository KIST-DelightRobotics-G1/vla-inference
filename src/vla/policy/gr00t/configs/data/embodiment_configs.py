...
from vla.policy.gr00t.data.types import (
    ActionConfig,
    ActionFormat,
...
MODALITY_CONFIGS = {
    ...
    # UNITREE_G1_SONIC with three cameras; everything else identical. KIST
    # registration (checkpoint handover doc UNITREE_G1_SONIC_3VIEWS.md) — not
    # in upstream Isaac-GR00T@5ac4e6b.
    "unitree_g1_sonic_3views": {
        "video": ModalityConfig(
            delta_indices=[0],

...
class EmbodimentTag(Enum):
    ...
    UNITREE_G1_SONIC_3VIEWS = "unitree_g1_sonic_3views"
    """
    UNITREE_G1_SONIC with three cameras (ego_view, left_wrist, right_wrist)
    instead of one; state and action spaces are identical. KIST registration
    (checkpoint handover doc UNITREE_G1_SONIC_3VIEWS.md) — not in upstream
    Isaac-GR00T@5ac4e6b.
    """
...
POSTTRAIN_TAGS: frozenset[EmbodimentTag] = frozenset(
    {
        ...
        EmbodimentTag.UNITREE_G1_SONIC_3VIEWS,

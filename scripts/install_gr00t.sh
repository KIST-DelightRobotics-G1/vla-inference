...
#
# The commit is read from src/vla_old/gr00t_version.py so there is exactly one
...
COMMIT="$("$PYTHON" -c 'from vla_old.gr00t_version import EXPECTED_GR00T_COMMIT; print(EXPECTED_GR00T_COMMIT)')"

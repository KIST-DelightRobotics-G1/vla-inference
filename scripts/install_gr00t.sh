...
#
# The commit is read from kist_vla/gr00t_version.py so there is exactly one
...
COMMIT="$("$PYTHON" -c 'from kist_vla.gr00t_version import EXPECTED_GR00T_COMMIT; print(EXPECTED_GR00T_COMMIT)')"
